...
class Books(models.Model):
	...
	book_author = models.ForeignKey(Author, on_delete=models.CASCADE, default = "")
	...
	book_category = models.ForeignKey(Category, on_delete=models.CASCADE, default = "")
	date_added = models.DateField(default=timezone.now)
	book_info = models.CharField(max_length = 100, default="")
	# firstname = models.ForeignKey(Author, on_delete=models.CASCADE, default = "", related_name='author_firstname')
	# lastname = models.ForeignKey(Author, on_delete=models.CASCADE, default = "", related_name='author_lastname')
	# birthdate = models.ForeignKey(Author, on_delete=models.CASCADE, default = "", related_name='author_birthdate')
